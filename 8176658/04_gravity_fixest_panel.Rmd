...
$$
E\left(\text { Trade }_{i, j, t}\right)=\gamma_{i,t}^{\text {Exporter }} \times \gamma_{j,t}^{\text {Importer }}  \times \gamma_{t}^{\text {Year }} 
\times \gamma_{i,j}^{\text {Pair}}
\times \text { RTA }_{i j, t}^{\beta}
...
E\left(\text { Trade }_{i, j, t}\right)=\exp \left(\gamma_{i,t}^{\text {Exporter }}+\gamma_{j,t}^{\text {Importer }}+\gamma_{t}^{\text {Year }}+ \gamma_{i,j}^{\text {Pair}} + \beta \times  \text { RTA }_{i j, t}\right)
$$
