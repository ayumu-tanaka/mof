![image](https://github.com/ayumu-tanaka/mof/assets/63719198/3f5a3842-0d0e-428a-972b-4b325ca027bc)# 2024年度財政経済理論研修 「国際貿易論」
...
- テーマ1: 重力方程式を用いた政策効果分析について。R/Rマークダウンによる。
- テーマ2: 教科書の章末にある「Report assignment レポート課題」から１つ選択。
  - テーマ2選択の場合の、評価上限は、C（可）になります。
